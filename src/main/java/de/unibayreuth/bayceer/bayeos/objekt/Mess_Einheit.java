 ...
 * @author  oliver
 */
public class Mess_Einheit extends Objekt {
	...
	/** Creates a new instance of Einheit */
    public Mess_Einheit(Vector v) {
        super(v);
        this.bezeichnung = (String)v.elementAt(super.INDEX_COUNT + 0);
        this.beschreibung = (String)v.elementAt(super.INDEX_COUNT + 1);
        this.symbol = (String)v.elementAt(super.INDEX_COUNT + 2);
    }
